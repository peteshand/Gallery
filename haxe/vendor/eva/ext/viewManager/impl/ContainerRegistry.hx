...
@:meta(Event(name = "containerAdd", type = "eva.ext.viewManager.impl.ContainerRegistryEvent"))
@:meta(Event(name = "containerRemove", type = "eva.ext.viewManager.impl.ContainerRegistryEvent"))
@:meta(Event(name = "rootContainerAdd", type = "eva.ext.viewManager.impl.ContainerRegistryEvent"))
@:meta(Event(name = "rootContainerRemove", type = "eva.ext.viewManager.impl.ContainerRegistryEvent"))
/**
 * @private
 */
class ContainerRegistry extends EventDispatcher {
	 ...
	 * @private
	 */
	public function addContainer(container:Dynamic):ContainerBinding {
	 ...
	 * @private
	 */
	public function removeContainer(container:Dynamic):ContainerBinding {
