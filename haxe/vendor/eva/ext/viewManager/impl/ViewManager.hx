...
@:meta(Event(name = "containerAdd", type = "eva.ext.viewManager.impl.ViewManagerEvent"))
@:meta(Event(name = "containerRemove", type = "eva.ext.viewManager.impl.ViewManagerEvent"))
@:meta(Event(name = "handlerAdd", type = "eva.ext.viewManager.impl.ViewManagerEvent"))
@:meta(Event(name = "handlerRemove", type = "eva.ext.viewManager.impl.ViewManagerEvent"))
/**
 * @private
 */
class ViewManager extends EventDispatcher implements IViewManager implements DescribedType {
	 ...
	 * @inheritDoc
	 */
	public function addContainer(container:Dynamic):Void {
	 ...
	 * @inheritDoc
	 */
	public function removeContainer(container:Dynamic):Void {
